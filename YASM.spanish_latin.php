...
$txt['YASM_last_viewed'] = '&Uacute;ltimos %d miembros vistos';
...
$txt['YASM_strings'] = array(
	...
	'show' => 'Reemplazar el texto del bot&oacute;n &quot;{show}&quot; con:' . $txt['YASM_default'],
	'hide' => 'Reemplazar el texto del bot&oacute;n &quot;{hide}&quot; con:' . $txt['YASM_default'],
	'text' => 'Reemplazar &quot;{tag_name}&quot; header con:' . $txt['YASM_default'],
	'expanded' => '&iquest;Predeterminado a estado expandido globalmente?<div class="smalltext"><strong>NOTA:</strong>  No afecta a las etiquetas que especifican estado expandido!</div>',
	'no_guests' => '&iquest;Desactivar {tag_name} para invitados globalmente?<div class="smalltext"><strong>NOTA:</strong>  No afecta a las etiquetas que especifican el estado del invitado!</div>',
	'no_border' => 'Desactivar línea debajo {tag_name} del encabezado?',
	'show_log' => 'Mostrar qué miembros vieron el {tag_name}?',
	'limit_log' => '&iquest;Número de miembros para mostrar que vieron el {tag_name}?<div class="smalltext"><strong>NOTA:</strong>  Establecer en <strong>0</strong> para mostrar a todos!</div>',
